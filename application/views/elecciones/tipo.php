	...
	<body style="color:white">
		...
		<div class="row">
			<div class="col-md-12">
		 <h1><img src="<?php echo base_url('plantilla/assets/images/azul.png'); ?>" alt="">Derecha</h1>
			</div>
			<div class="row">
				<div class="col-md-12">
			<h1><img src="<?php echo base_url('plantilla/assets/images/rojo.png'); ?>" alt="">Izquierda</h1>
				</div>
		...
		<script type="text/javascript">
			...
			<?php if ($elecciones5): ?>
				<?php foreach ($elecciones5 as $lugarTemporal):?>
				...
				<?php if ($elecciones6): ?>
					<?php foreach ($elecciones6 as $lugarTemporal):?>
					var coordenadaTemporal= new google.maps.LatLng(<?php echo $lugarTemporal->latitud ?>, <?php echo $lugarTemporal->longitud ?>);
					//////////////MARCADOR
						var marcador=new google.maps.Marker({
							position:coordenadaTemporal,
